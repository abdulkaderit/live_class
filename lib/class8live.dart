...
//                         Navigator.push(context, MaterialPageRoute(builder: (context)=>UserInfo(name:_emailController.text)));
//                       }
//                     },child: Text("Submit")),),
//
//               SizedBox(
...
//   final String msg;
//   const Page1({super.key, required this.msg });
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
//       body: Column(
//         children: [
//           Text(msg,style: TextStyle(fontSize: 25,color: Colors.white),),
//           ElevatedButton(onPressed: (){
//             Navigator.pop(context);
//           }, child: Text("Back")),
//
